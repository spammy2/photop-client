...
SimpleSocketAPI.SupportsETF = "undefined" != typeof TextEncoder, SimpleSocketAPI.Operations = {}, SimpleSocketAPI.TotalMessages = 0, SimpleSocketAPI.ConnectSocket = function () {
	...
	return t
}, SimpleSocket.socketLatancy = 0, SimpleSocket.CLIENT_ID = "ClientID_REPLACE_ake83awi25", SimpleSocket.connect = async function (e) {
	SimpleSocketAPI.IsConnecting = !0, SimpleSocketAPI.ID = e.project_id, SimpleSocketAPI.Token = e.client_token, await SimpleSocketAPI.TryConnection()
}, SimpleSocketAPI.DefaultConfig = null, SimpleSocket.setDefaultConfig = function (e) {
	if (null == SimpleSocketAPI.IsConnecting) return void SimpleSocketAPI.Debug("ERROR: Must connect WebSocket first, call SimpleSocket.connect({ project_id, client_token });", !0, !0);
	...
	} else null != SimpleSocket.remoteFunctions[e.Func] && SimpleSocket.remoteFunctions[e.Func](e.Data, e.Config)
	...
	} else "CloseSub" == e.T && null != SimpleSocketAPI.Operations["Subscribe_" + e.Func + "_Remote"] && (delete SimpleSocketAPI.Operations["Subscribe_" + e.Func + "_Remote"], SimpleSocketAPI.Debug("[REMOTE] CLOSING SUB: Function: " + e.Func))
}, SimpleSocket.editSubscribe = function (e, t, o) {
	if (null == SimpleSocketAPI.IsConnecting) return void SimpleSocketAPI.Debug("ERROR: Must connect WebSocket first, call SimpleSocket.connect({ project_id, client_token });", !0, !0);
	let n = {};
	if (null != t && (n.Ftr = t), null != o && (n.Con = o), Object.keys(n) < 1) return;
	let S = e.substring(18);
	if (null == SimpleSocketAPI.Operations[S] || null != SimpleSocketAPI.Operations[S].Func) return;
